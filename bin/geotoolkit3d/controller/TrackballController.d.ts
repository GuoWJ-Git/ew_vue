 ...
 * <br>
 */
export class TrackballController extends AbstractController {
    /**
     * A controller that emulates an 'Trackball' behavior.<br>
     * <br>
     * This controller let the user manipulate the camera position using mouse or touch input.<br>
     ...
     * @param options.panspeed Panning speed factor
     * @param options.noroll Disable rolling
     ...
     */
    constructor(options?: object | { enabled?: boolean; nozoom?: boolean; zoomspeed?: number; mindistance?: number; maxdistance?: number; norotate?: boolean; rotatespeed?: number; nopan?: boolean; panspeed?: number; noroll?: boolean; nodblclick?: boolean; dblclickspeed?: number; } );
    /**
     ...
     * @param options.dblclickspeed Double click speed emulation (for touch devices) in ms
     */
    setOptions(options?: object | { enabled?: boolean; nozoom?: boolean; zoomspeed?: number; mindistance?: number; maxdistance?: number; norotate?: boolean; rotatespeed?: number; nopan?: boolean; panspeed?: number; noroll?: boolean; nodblclick?: boolean; dblclickspeed?: number; } ): this;
    /**
     * Get trackball controller options
     * (see {@link @int/geotoolkit3d/controller/TrackballController.TrackballController#setOptions} for more info)
     */
