        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="每冲体积(L/冲):" prop="pumpVolume">
              <el-input
                v-model="formModel.pumpVolume"
                placeholder="请输入"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="井眼直径(in):" prop="holeDiameter">
              <el-input
                v-model="formModel.holeDiameter"
                placeholder="请输入"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="钻具外径(in):" prop="pipeDiameter">
              <el-input
                v-model="formModel.pipeDiameter"
                placeholder="请输入"
              ></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="formModel.aftereffectNum"
                placeholder="请输入"
              ></el-input>
            </el-form-item>
          </el-col>
  ...
  methods: {
    ...
    async getTableData() {
      try {
        ...
        const { data, code, message } = await getPumpStrokeList(params);
        if (code === 200) {
    ...
    calculate() {
      this.$refs["formRef"]?.validate(async (valid) => {
        ...
        try {
          ...
          const { code, message, data } = await pumpStrokeCalculate(params);
          if (code === 200) {
